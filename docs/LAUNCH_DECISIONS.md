...
| Most recent application release baseline (historical evidence gaps disclosed) | Release-evidence and Vercel build-boundary commit `72f1a00cb3e5bbd49496735a4c9eac4d58c5e77b`; GitHub/Vercel Production deployment `5549965132` / `2vtyCEztpryE2hrKZ8MYsuNBUH5H`; Production Quality run `29891910210` and production smoke run `29891948166` passed; authenticated alias evidence is `docs/evidence/vercel-production-alias-2026-07-22-pr27.json`. `docs/releases/2026-07-22-pr27.md` records the exact candidate, Preview, Production, canonical alias assignment, reproducible install and ignored-build bootstrap result, Chromium/Firefox/Desktop and mobile WebKit, seven visual baselines, five-route Lighthouse budgets, the private/public demo boundary, and public smoke evidence while disclosing the protected-Preview semantic-smoke and current authenticated-playback gaps. Each later release must retain its own PR/Vercel evidence rather than silently overwriting this baseline. | Engineering release / 2026-07-22 |
