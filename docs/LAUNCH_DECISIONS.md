...
| Most recent application release baseline (historical evidence gaps disclosed) | Demo-boundary release commit `61d23de8930877ae92ccabbd8fd11ebc424f7b47`; GitHub/Vercel Production deployment `5547414342` / `6VSPNCqJPMFbdDXt3ZEyyiz3XFtt`; Production Quality run `29877722603` and production smoke run `29877752755` passed; authenticated alias evidence is `docs/evidence/vercel-production-alias-2026-07-22.json`. `docs/releases/2026-07-22-pr19.md` records the exact candidate, Preview, Production, canonical alias assignment, lifecycle gates, private/public demo boundary, and public smoke evidence while disclosing the protected-Preview semantic-smoke and current authenticated-playback gaps. Each later release must retain its own PR/Vercel evidence rather than silently overwriting this baseline. | Engineering release / 2026-07-22 |
