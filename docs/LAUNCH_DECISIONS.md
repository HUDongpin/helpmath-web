...
| Confirm session maximum is 12 hours and bounded by the global expiry | Implemented and covered by unit and browser checks. During post-merge verification from the exact PR #15 checkout, the operator retained a credential-free canonical machine result with all `4/4` localized private demo routes, `12/12` private assets, `2/2` private runtimes, `failures: []`, and the exact global close `2026-07-28T15:59:00.000Z`: `docs/evidence/executive-preview-canonical-pr15-2026-07-22.json`, SHA-256 `05c5297a04b12ab934272f8946a7b1105e4a1920ee28e582cd981bb690f9ac63`. The canonical JSON does not contain commit, deployment, or observation-time fields; its operator-recorded identity and handling envelope is `docs/evidence/executive-preview-production-pr15-2026-07-22.json`, SHA-256 `798efec3041590068a5cc7dfe8ece2d6786252e66ff67fb6d1f368c81561ac25`, corroborated by the separate deployment and alias evidence. A focused two-demo browser check also passed `1/1`, but no standalone Playwright report, trace, screenshot, access value, signing value, cookie, or browser state was retained, so only the canonical smoke is represented as machine evidence. Private delivery, recipient acknowledgement, and the post-meeting close action remain pending. | Engineering production verification / 2026-07-22 |
...
| Most recent application release baseline (historical evidence gaps disclosed) | Launch-gate release commit `d3b84e8dcf539d8859641bdb58cbaa5237efc461`; GitHub Production deployment `5544827753`; Vercel Production deployment `dpl_GAwLFodMFiqAE7RDibwp77mgwjUQ`; Production Quality run `29863649827`, zero-failure production-smoke run `29863684054`, and same-commit `16/16` stable-link run `29863927541` passed. `docs/releases/2026-07-22-pr15.md` records the exact candidate, protected Preview, Production, canonical alias assignment, launch-gate state, retained credential-free authenticated private-demo result, safe reviewer-entry checks, and scoped Spanish mobile regression evidence. Supporting current records are `docs/evidence/vercel-production-alias-pr15-2026-07-22.json`, `docs/evidence/executive-preview-canonical-pr15-2026-07-22.json`, `docs/evidence/executive-preview-production-pr15-2026-07-22.json`, and `docs/evidence/production-ui-pr15-2026-07-22.json`; the historical PR #13 evidence remains immutable in its own release record. The protected-Preview semantic-smoke and external approval gaps remain disclosed, every launch gate remains `holding`, and the final cutover candidate still requires fresh exact-commit preflight evidence before DNS changes. | Engineering release / 2026-07-22 |
