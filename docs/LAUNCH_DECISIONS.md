...
| Most recent application release baseline (historical evidence gaps disclosed) | Resource-discovery and reflow-accessibility release commit `cb90241589986e71df32fbc9b7ec65fa457fe1a1`; GitHub/Vercel Production deployment `5549581818` / `57w8o5ZyHVW7WktXpTCrLkaVpvHg`; Production Quality run `29889819033` and production smoke run `29889844056` passed; authenticated alias evidence is `docs/evidence/vercel-production-alias-2026-07-22-pr26.json`. `docs/releases/2026-07-22-pr26.md` records the exact candidate, Preview, Production, canonical alias assignment, Chromium/Firefox/Desktop and mobile WebKit, seven visual baselines, five-route Lighthouse budgets, the private/public demo boundary, and public smoke evidence while disclosing the protected-Preview semantic-smoke and current authenticated-playback gaps. Each later release must retain its own PR/Vercel evidence rather than silently overwriting this baseline. | Engineering release / 2026-07-22 |
