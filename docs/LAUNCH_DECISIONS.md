...
| Most recent application release baseline (historical evidence gaps disclosed) | Mobile-fragment and research-attribution release commit `70c7346eb759a32ad276f992886bffdea50ec62b`; GitHub/Vercel Production deployment `5550502295` / `911gyPapPtTAkhrCDUyBP6ZDDdq2`; Production Quality run `29894885323` and production smoke run `29894932455` passed; authenticated alias evidence is `docs/evidence/vercel-production-alias-2026-07-22-pr30.json`. `docs/releases/2026-07-22-pr30.md` records the exact candidate, Preview, Production, READY-only canonical alias transition, Chromium/Firefox/Desktop and mobile WebKit, seven visual baselines, five-route Lighthouse budgets, bilingual research-attribution boundary, private/public demo boundary, and public smoke evidence while disclosing the protected-Preview semantic-smoke and current authenticated-playback gaps. Each later release must retain its own PR/Vercel evidence rather than silently overwriting this baseline. | Engineering release / 2026-07-22 |
