...
| Most recent application release baseline (historical evidence gaps disclosed) | Discovery/browser release commit `e27c9b56a7c7b07ce481c3f73b712cf6fba893ad`; GitHub/Vercel Production deployment `5548495172` / `E8N36XGzudoDdNr6Qmqkhw7NNEeG`; Production Quality run `29883832758`, production smoke run `29883859644`, and Executive Preview lifecycle run `29883945321` passed; authenticated alias evidence is `docs/evidence/vercel-production-alias-2026-07-22-pr21.json`. `docs/releases/2026-07-22-pr21.md` records the exact candidate, Preview, Production, canonical alias assignment, WebKit and visual gates, private/public demo boundary, lifecycle observation, and public smoke evidence while disclosing the protected-Preview semantic-smoke and current authenticated-playback gaps. Each later release must retain its own PR/Vercel evidence rather than silently overwriting this baseline. | Engineering release / 2026-07-22 |
