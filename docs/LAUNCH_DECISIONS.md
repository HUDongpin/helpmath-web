...
| Most recent application release baseline (historical evidence gaps disclosed) | Accessibility release commit `59bb5472568da389061464f199d94365a28ddcc1`; GitHub/Vercel Production deployment `5554573849` / `HYteuZes7FqGZwLMTfsqe8Qy4jzw`; Production Quality run `29916020531` and production smoke run `29916084135` passed; authenticated alias evidence is `docs/evidence/vercel-production-alias-2026-07-22-pr37.json`. `docs/releases/2026-07-22-pr37.md` records the exact candidate, protected Preview, Production, READY-only alias transition, current canonical alias binding, Chromium/Firefox/desktop and mobile WebKit, eight visual baselines, five-route Lighthouse budgets, localized status landmarks, deterministic skip-link focus, private/public demo boundary, and zero-failure public smoke. The immediately preceding Avenir-first release is retained separately in `docs/releases/2026-07-22-pr36.md` with its historical alias evidence. Remaining gaps include protected-Preview semantic smoke, current authenticated playback, no-JavaScript mobile navigation, a real-device Safari Full Keyboard Access spot check, and off-device archive custody. Each later release must retain its own PR/Vercel evidence rather than silently overwriting this baseline. | Engineering release / 2026-07-22 |
