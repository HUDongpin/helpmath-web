...
| Release commit and Vercel deployment evidence | Pre-cutover baseline: `cb90241589986e71df32fbc9b7ec65fa457fe1a1`; GitHub deployment `5549581818`; Vercel deployment locator `57w8o5ZyHVW7WktXpTCrLkaVpvHg`; successful same-commit Quality run `29889819033`; successful production-smoke run `29889844056`; authenticated canonical alias evidence `docs/evidence/vercel-production-alias-2026-07-22-pr26.json`; see `docs/releases/2026-07-22-pr26.md`. Replace with the final reviewed cutover candidate before DNS changes. |
