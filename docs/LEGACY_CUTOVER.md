...
| Release commit and Vercel deployment evidence | Pre-cutover baseline: `72f1a00cb3e5bbd49496735a4c9eac4d58c5e77b`; GitHub deployment `5549965132`; Vercel deployment locator `2vtyCEztpryE2hrKZ8MYsuNBUH5H`; successful same-commit Quality run `29891910210`; successful production-smoke run `29891948166`; authenticated canonical alias evidence `docs/evidence/vercel-production-alias-2026-07-22-pr27.json`; see `docs/releases/2026-07-22-pr27.md`. Replace with the final reviewed cutover candidate before DNS changes. |
