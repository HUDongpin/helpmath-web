...
| Release commit and Vercel deployment evidence | Current pre-cutover application baseline: `d3b84e8dcf539d8859641bdb58cbaa5237efc461`; GitHub deployment `5544827753`; Vercel deployment `dpl_GAwLFodMFiqAE7RDibwp77mgwjUQ`; successful same-commit Quality run `29863649827`; zero-failure production-smoke run `29863684054`; successful `16/16` stable-link run `29863927541`; authenticated canonical alias evidence `docs/evidence/vercel-production-alias-pr15-2026-07-22.json`; retained credential-free private-demo result `docs/evidence/executive-preview-canonical-pr15-2026-07-22.json`; see `docs/releases/2026-07-22-pr15.md`. All launch gates remain `holding`. Replace this record with the final reviewed cutover candidate and fresh exact-commit preflight evidence before DNS changes. |
