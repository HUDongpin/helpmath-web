...
| Release commit and Vercel deployment evidence | Pre-cutover baseline: `70c7346eb759a32ad276f992886bffdea50ec62b`; GitHub deployment `5550502295`; Vercel deployment locator `911gyPapPtTAkhrCDUyBP6ZDDdq2`; successful same-commit Quality run `29894885323`; successful production-smoke run `29894932455`; authenticated canonical alias evidence `docs/evidence/vercel-production-alias-2026-07-22-pr30.json`; see `docs/releases/2026-07-22-pr30.md`. Replace with the final reviewed cutover candidate before DNS changes. |
