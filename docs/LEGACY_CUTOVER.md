...
| Release commit and Vercel deployment evidence | Pre-cutover baseline: `e27c9b56a7c7b07ce481c3f73b712cf6fba893ad`; GitHub deployment `5548495172`; Vercel deployment locator `E8N36XGzudoDdNr6Qmqkhw7NNEeG`; successful same-commit Quality run `29883832758`; successful production-smoke run `29883859644`; authenticated canonical alias evidence `docs/evidence/vercel-production-alias-2026-07-22-pr21.json`; see `docs/releases/2026-07-22-pr21.md`. Replace with the final reviewed cutover candidate before DNS changes. |
