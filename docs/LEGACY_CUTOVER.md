...
| Release commit and Vercel deployment evidence | Pre-cutover baseline: `61d23de8930877ae92ccabbd8fd11ebc424f7b47`; GitHub deployment `5547414342`; Vercel deployment locator `6VSPNCqJPMFbdDXt3ZEyyiz3XFtt`; successful same-commit Quality run `29877722603`; successful production-smoke run `29877752755`; authenticated canonical alias evidence `docs/evidence/vercel-production-alias-2026-07-22.json`; see `docs/releases/2026-07-22-pr19.md`. Replace with the final reviewed cutover candidate before DNS changes. |
