...
| Release commit and Vercel deployment evidence | Pre-cutover baseline: `f297d0230264577b19f5f06274bd802a6e725b48`; GitHub deployment `5552454732`; Vercel deployment locator `FirM93JbPzFneEXQX4UWJZdN9XYn`; successful same-commit Quality run `29905358787`; successful production-smoke run `29905407356`; authenticated canonical alias evidence `docs/evidence/vercel-production-alias-2026-07-22-pr32.json`; see `docs/releases/2026-07-22-pr32.md`. Replace with the final reviewed cutover candidate before DNS changes. |
