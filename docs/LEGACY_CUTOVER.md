...
| Release commit and Vercel deployment evidence | Pre-cutover baseline: `e5a18964c5cba2035e1221314b0f29ec4eb93089`; GitHub deployment `5547952436`; Vercel deployment locator `EDKwCDxC2zm4E5X51kMWKMU8HgyE`; successful same-commit Quality run `29880825422`; successful production-smoke run `29880861964`; authenticated canonical alias evidence `docs/evidence/vercel-production-alias-2026-07-22-pr20.json`; see `docs/releases/2026-07-22-pr20.md`. Replace with the final reviewed cutover candidate before DNS changes. |
