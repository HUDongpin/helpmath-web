...
| Release commit and Vercel deployment evidence | Pre-cutover baseline: `3e31933189cb74df8b1565dadbb3419375c4f6f8`; GitHub deployment `5553345433`; Vercel deployment locator `F4NmkqsGjWJdRCCQ7gNveLqkumxP`; successful same-commit Quality run `29909912133`; successful production-smoke run `29909963039`; authenticated canonical alias evidence `docs/evidence/vercel-production-alias-2026-07-22-pr34.json`; see `docs/releases/2026-07-22-pr34.md`. Replace with the final reviewed cutover candidate before DNS changes. |
