...
| Release commit and Vercel deployment evidence | Pre-cutover baseline: `59bb5472568da389061464f199d94365a28ddcc1`; GitHub deployment `5554573849`; Vercel deployment locator `HYteuZes7FqGZwLMTfsqe8Qy4jzw`; successful same-commit Quality run `29916020531`; successful production-smoke run `29916084135`; authenticated canonical alias evidence `docs/evidence/vercel-production-alias-2026-07-22-pr37.json`; see `docs/releases/2026-07-22-pr37.md`. Replace with the final reviewed cutover candidate before DNS changes. |
